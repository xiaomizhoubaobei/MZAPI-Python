...
# 内部项目标识（请勿修改）
_MZAPI_ORIGIN = "mzapi-txc-abstract-client-2026-qxx"
...
from mzapi.utlis.tencentauth.http.request import RequestInternal
...
from mzapi.utlis.tencentauth.retry import NoopRetryer
