...
当前支持的识别能力：
  - RecognizeGeneralText：通用文字识别，支持 27 种语言

使用示例：
    >>> from mzapi.huaweicloud import RecognizeGeneralText
    >>> client = RecognizeGeneralText(ak="your_ak", sk="your_sk")
    >>> response = client.recognize(image_url="https://example.com/image.jpg")
"""
